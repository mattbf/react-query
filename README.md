...
# How to setup the React Query Devtools with nextjs
```ts
'use client';
  ...
  return new QueryClient({
    defaultOptions: {
      queries: {
        ...
        staleTime: 5 * 1000, // 5 seconds as the global default, can be configured lower down
      },
    },
  });
}
...
export function Providers({ children }: { children: React.ReactNode }) {
  // see tanstack docs for why we do this: https://tanstack.com/query/latest/docs/framework/react/guides/advanced-ssr#initial-setup
